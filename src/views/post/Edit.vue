...
export default {
    setup () {
        ...
        //state post di bikin reactive
        const post = reactive({
            title: '',
            content: ''
        })

        //state validation di bikin ref
        ...
        onMounted(() => {
            ...
            .then(response => {
                ...
                //hasil laravel akan di assign ke state post
        ...
        //method update berjalan ketika form sudah di submit
        function update() {
            ...
            let content = post.content
               ...
               axios.put(`http://localhost:8000/api/post/${route.params.id}`, {
                ...
                content: content
                    ...
                    //assign state validation if error
